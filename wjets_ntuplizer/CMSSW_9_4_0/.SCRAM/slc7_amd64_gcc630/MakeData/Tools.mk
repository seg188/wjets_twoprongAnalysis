...
coral_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc630/cms/coral/CORAL_2_3_21-fmblme3/include/LCG
...
ALL_TOOLS      += eigen
eigen_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc630/external/eigen/f3a22f35b044/include/eigen3
...
fastjet-contrib-archive_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc630/external/fastjet-contrib/1.026/include
...
fastjet-contrib_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc630/external/fastjet-contrib/1.026/include
...
ALL_TOOLS      += gbl
gbl_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc630/external/gbl/V02-01-03-fmblme/include
gbl_EX_LIB := GBL
gbl_EX_USE := eigen
...
geant4core_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc630/external/geant4/10.02.p02-fmblme3/include/Geant4
...
ALL_TOOLS      += hector
hector_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc630/external/hector/1.3.4_patch1-fmblme3/include
...
ALL_TOOLS      += lwtnn
lwtnn_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc630/external/lwtnn/1.0-fmblme2/include
lwtnn_EX_LIB := lwtnn
...
ALL_TOOLS      += mctester
mctester_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc630/external/mctester/1.25.0a-fmblme3/include
...
py2-numpy-c-api_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc630/external/py2-numpy/1.12.1-fmblme/c-api/core/include
...
ALL_TOOLS      += rivet
rivet_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc630/external/rivet/2.5.4/include
rivet_EX_LIB := Rivet
...
roofitcore_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc630/lcg/root/6.10.08/include
...
root_interface_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc630/lcg/root/6.10.08/include
root_interface_EX_USE := root_cxxdefaults

ALL_TOOLS      += rootcling
rootcling_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc630/lcg/root/6.10.08/include
...
ALL_TOOLS      += sherpa
sherpa_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc630/external/sherpa/2.2.4-fmblme2/include/SHERPA-MC
...
tensorflow-c_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc630/external/tensorflow-c/1.1.0-fmblme3/include
tensorflow-c_EX_LIB := tensorflow

ALL_TOOLS      += tensorflow-cc
tensorflow-cc_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc630/external/tensorflow-cc/1.3.0-fmblme/tensorflow_cc/include
...
tkonlinesw_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc630/external/tkonlinesw/4.1.0-1-fmblme3/include
...
ALL_TOOLS      += yoda
yoda_EX_INCLUDE := /cvmfs/cms.cern.ch/slc7_amd64_gcc630/external/yoda/1.6.7/include
yoda_EX_LIB := YODA
